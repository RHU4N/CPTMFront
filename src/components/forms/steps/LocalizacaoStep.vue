<template>
  <section class="wizard-step card">
    <div class="wizard-step-head">
      <div>
        <span class="eyebrow">Passo 5 de 7</span>
        <h3 class="section-title">Localização</h3>
        <p class="section-subtitle">Município, eixo ferroviário, estação, via, trecho e georreferência do ponto de efluente.</p>
      </div>
    </div>
    ...
    <div class="wizard-grid wizard-grid--2">
      ...
      <label class="field-stack">
        <span class="field-label">Linha CPTM</span>
      ...
      <label class="field-stack">
        <span class="field-label">Estação CPTM</span>
      ...
      <label class="field-stack">
        <span class="field-label">Via CPTM</span>
      ...
      <label class="field-stack">
        <span class="field-label">Trecho/Sentido CPTM</span>
      ...
      <label class="field-stack">
        <span class="field-label">KM / Poste</span>
    ...
    <div class="wizard-grid wizard-grid--2">
      <label class="field-stack">
        <span class="field-label">Latitude WGS84 (graus decimais)</span>
        <input v-model.number="form.nrLatGrauDecimalWgs84" class="input" :class="{ 'is-invalid': errors.nrLatGrauDecimalWgs84 }" type="number" step="any" inputmode="decimal" placeholder="-23.550520" :disabled="loading" @input="setManualMode" />
        <small v-if="errors.nrLatGrauDecimalWgs84" class="field-error">{{ errors.nrLatGrauDecimalWgs84 }}</small>
      </label>

      <label class="field-stack">
        <span class="field-label">Longitude WGS84 (graus decimais)</span>
        <input v-model.number="form.nrLongGrauDecimalWgs84" class="input" :class="{ 'is-invalid': errors.nrLongGrauDecimalWgs84 }" type="number" step="any" inputmode="decimal" placeholder="-46.633308" :disabled="loading" @input="setManualMode" />
        <small v-if="errors.nrLongGrauDecimalWgs84" class="field-error">{{ errors.nrLongGrauDecimalWgs84 }}</small>
      </label>

      <label class="field-stack">
        <span class="field-label">Latitude SIRGAS2000 (metros)</span>
        <input v-model.number="form.nrLatMetrosSirgas2000" class="input" type="number" step="any" inputmode="decimal" placeholder="Metros (opcional)" :disabled="loading" />
      </label>

      <label class="field-stack">
        <span class="field-label">Longitude SIRGAS2000 (metros)</span>
        <input v-model.number="form.nrLongMetrosSirgas2000" class="input" type="number" step="any" inputmode="decimal" placeholder="Metros (opcional)" :disabled="loading" />
      </label>
    </div>
